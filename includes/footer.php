<?php
	...
	//counting total number of topics
...
<div class="col-md-4">
				<div class="sidebar">
					...
					<div class="list-group block ">
						<a href="<?php echo APPURL; ?>" class="list-group-item active">All Topics <span class="badge pull-right"><?php echo $allTopics->all_topics; ?></span></a> 
